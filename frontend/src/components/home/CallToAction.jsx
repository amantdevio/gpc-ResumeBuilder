...
const CallToAction = () => {
    return (
        <div id='cta' className='border-y border-dashed border-slate-200 w-full max-w-5xl mx-auto px-4 sm:px-10 lg:px-16 mt-20 sm:mt-28'>
            <div className="flex flex-col md:flex-row text-center md:text-left items-center justify-between gap-8 px-2 sm:px-3 md:px-10 py-12 sm:py-16 md:py-20 -mt-4 sm:-mt-10 -mb-4 sm:-mb-10 w-full">
