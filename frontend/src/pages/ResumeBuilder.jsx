...
const handleShare = async () => {
  ...
  try {
    ...
    // user cancelled share or permission issue
    console.error(err);
  }
};
  ...
  const saveResume = async () => {
    try {
      let updatedResumeData = structuredClone({
        ...resumeData,
      ...
      // remove image from JSON payload when a new file object exists
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              ...
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <Link to={`/view/${resumeId}`} className='flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600 rounded-lg ring-purple-300 hover:ring transition-colors'>
            ...
            {/* --resume preview  */}
            <ResumePriview data={resumeData} template={resumeData.template} accentColor={resumeData.accent_color}/>
          </div>
        </div>
      </div>
      {/* <Footer/> */}
